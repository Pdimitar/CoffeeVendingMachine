...
namespace VendingMachine.Service
{
    public class VendingMachineService : IVendingMachineService
    {
            ...
            while (true)
            {
                ...
                switch (selectedOption)
                {
                    case "1":
                        ...
                        PurchaseSelectedCoffee(selectedCoffee);
                        break;
                    case "2":
                    ...
                    case "3":
                        ...
                        PurchaseSelectedCoffee(selectedImportedCoffee);
                        break;
                    case "4":
        ...
        private void PurchaseSelectedCoffee(string selectedCoffee)
        {
            if (_coffeeService.DoesItemExist(selectedCoffee))
            {
                var coffeeToMake = _coffeeService.GetSelectedCoffee(selectedCoffee);
